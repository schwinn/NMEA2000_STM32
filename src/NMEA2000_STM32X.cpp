...
bool tNMEA2000_STM32X::CANSendFrame(unsigned long id, unsigned char len, const unsigned char *buf, bool wait_sent)
{
...
bool tNMEA2000_STM32X::CANGetFrame(unsigned long &id, unsigned char &len, unsigned char *buf)
{
...
void tNMEA2000_STM32X::init(void)
{
...
extern "C" void HAL_CAN_TxMailbox0CompleteCallback(CAN_HandleTypeDef *CanHandle)
{
  ...
  tNMEA2000_STM32X *_can = (tNMEA2000_STM32X *)canObj->__this;
  CAN_message_t txmsg;
